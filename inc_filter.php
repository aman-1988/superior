<?php
 ...
 $json_data10 = getorder9("https://".$SHOPIFY_SHOP."/admin/api/unstable/collections/".$name."/products.json?sort_order=price-asc&published_scope=global&limit=250");
...
} else if(strpos($mystring3, $word81) !== false) {
...
} else if(strpos($mystring3, $word91) !== false) {
...
} else if(strpos($mystring3, $word71) !== false) {
